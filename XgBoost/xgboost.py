...
Original file is located at
    https://colab.research.google.com/drive/1GPs1M16RuDgXbXmUCl3inw-8JMmO_gRk
"""
    ...
    def _find_better_split(self,feature_idx):
        ...
        for i in range(0,self.n  -1):
            ...
            gain = 0.5 *((sum_g_left**2 /(sum_h_left + self.reg_lambda ))+ 
                         (sum_g_right**2 /(sum_h_right+self.reg_lambda))- (sum_g**2/(sum_h + self.reg_lambda))) - self.gamma/2 
